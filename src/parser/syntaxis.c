...
int syntaxis_is_ok(t_token **token) // en los errores de sintaxis hay que incluir las comillas impares que le falta su pareja y generarse un error de sintaxis
{
